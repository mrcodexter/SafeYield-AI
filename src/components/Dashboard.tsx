      ...
      <aside className="w-64 border-r border-pacifica-border p-6 hidden lg:flex flex-col">
        ...
        <nav className="space-y-2 flex-1">
          {[
            ...
            { id: 'strat', icon: TrendingUp, label: 'Strategies' },
      ...
      <main className="flex-1 overflow-y-auto p-8">
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-4">
            ...
            <button className="px-6 py-2.5 bg-pacifica-blue text-pacifica-dark font-bold rounded-xl hover:bg-white transition-colors shadow-lg shadow-pacifica-blue/20">
              Connect Wallet
            </button>
          </div>
        </header>
        ...
        <section className="mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-pacifica-blue text-sm font-bold flex items-center hover:underline">
